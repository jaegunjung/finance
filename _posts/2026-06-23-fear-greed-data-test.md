...
date: 2026-06-23
categories: strategy
tags: [fear-greed, sentiment, data-analysis, contrarian, sp500, bitcoin]
excerpt: "Testing the 'buy fear, sell greed' rule against 10+ years of Fear & Greed Index data. The results are more nuanced than the slogan."
excerpt_en: "Testing the 'buy fear, sell greed' rule against 10+ years of Fear & Greed Index data. The results are more nuanced than the slogan."
excerpt_ko: "10년 이상의 공포·탐욕 지수 데이터로 '공포에 사고 탐욕에 팔아' 규칙을 검증한다. 결과는 슬로건보다 복잡하다."
---
...
데이터의 핵심 통찰: 감정 극단은 바닥의 정확한 *타이밍*보다 매집 기회의 *질*을 파악하는 데 더 유용하다.
