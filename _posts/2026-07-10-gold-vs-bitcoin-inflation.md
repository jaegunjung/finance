...
date: 2026-07-10
categories: macro
tags: [gold, bitcoin, inflation-hedge, macro, store-of-value, comparison]
excerpt: "Comparing gold and Bitcoin as inflation hedges across the 1970s and 2020s. The data reveals two very different tools for the same job."
excerpt_en: "Comparing gold and Bitcoin as inflation hedges across the 1970s and 2020s. The data reveals two very different tools for the same job."
excerpt_ko: "1970년대와 2020년대의 인플레이션 환경에서 금과 비트코인을 인플레이션 헤지로 비교한다. 데이터는 같은 역할을 위한 두 가지 매우 다른 도구를 드러낸다."
---
...
**교훈:** 금은 인플레이션 자체가 아니라 *통화 정책 신뢰성 상실*에 대해 헤지한다. 연준이 신뢰할 수 있게 인플레이션을 통제할 때 금은 아웃퍼폼하지 않는다.
