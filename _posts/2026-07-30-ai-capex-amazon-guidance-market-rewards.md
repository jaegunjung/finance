---
layout: post
title: "AI CapEx: Amazon Raises Guidance to $220B Too — But This Time the Market Says Yes"
title_en: "AI CapEx: Amazon Raises Guidance to $220B Too — But This Time the Market Says Yes"
title_ko: "AI CapEx — 아마존도 가이던스를 $220B로 상향했다, 그런데 이번엔 시장이 반겼다"
date: 2026-07-30
categories: sp500
tags: [AI, capex, hyperscaler, earnings, Amazon, AWS, Microsoft, Google, Meta, NVIDIA, AMZN, MSFT, GOOGL, META]
excerpt: "Amazon raised 2026 capex guidance to $220B and posted negative free cash flow — the same combination that got Alphabet punished five days ago. This time the stock jumped ~9-10% after hours on AWS's fastest revenue growth since 2021. Here's why the 'raise capex, get punished' pattern from our July 29 post just broke."
excerpt_en: "Amazon raised 2026 capex guidance to $220B and posted negative free cash flow — the same combination that got Alphabet punished five days ago. This time the stock jumped ~9-10% after hours on AWS's fastest revenue growth since 2021. Here's why the 'raise capex, get punished' pattern from our July 29 post just broke."
excerpt_ko: "아마존은 2026년 capex 가이던스를 $220B로 상향하고 마이너스 잉여현금흐름을 기록했다 — 닷새 전 알파벳을 응징받게 만든 것과 같은 조합이다. 그런데 이번엔 주가가 시간외에서 약 9~10% 급등했다. AWS가 2021년 이후 가장 빠른 매출 성장을 기록했기 때문이다. 7월 29일 글에서 짚었던 'capex를 올리면 응징당한다'는 패턴이 왜 깨졌는지 정리한다."
---
...
capex 측면에서는 아마존이 2026년 가이던스를 기존 약 $200B에서 **$220B**로 상향했다 — 워싱턴포스트는 이 $20B 증액을 이번 2분기 실적의 강세와 직접 연결했고, CNBC는 구체적으로 **메모리 부품 원가 상승**을 원인으로 지목했다 — 7월 26일 글에서 메타가 언급했던 "수요가 아닌 비용 주도" 흐름과 같은 패턴이다. 여러 매체(Investing.com, 24/7 Wall Street)는 이번 분기 아마존의 잉여현금흐름이 AI 인프라 지출 부담으로 **마이너스**로 전환됐다고도 보도했다 — 7월 22일 알파벳의 시가총액 약 $255B 증발을 촉발했던 것과 같은 신호다.
