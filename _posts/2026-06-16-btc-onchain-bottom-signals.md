...
date: 2026-06-16
categories: crypto
tags: [bitcoin, on-chain, MVRV, Puell-multiple, SOPR, bottom-detection]
excerpt: "MVRV Z-Score, Puell Multiple, and SOPR have historically clustered near Bitcoin cycle lows. A data-driven check on where they stand now."
excerpt_en: "MVRV Z-Score, Puell Multiple, and SOPR have historically clustered near Bitcoin cycle lows. A data-driven check on where they stand now."
excerpt_ko: "MVRV Z-Score, Puell Multiple, SOPR — 세 가지 온체인 지표가 역사적으로 비트코인 사이클 저점 근처에서 어떻게 움직였는지, 지금은 어떤 신호를 보내고 있는지 진단한다."
---
