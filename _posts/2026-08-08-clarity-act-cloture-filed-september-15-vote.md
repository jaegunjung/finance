---
layout: post
title: "Clarity Act: Thune Files Cloture, Locking In a September 15 Senate Showdown"
title_en: "Clarity Act: Thune Files Cloture, Locking In a September 15 Senate Showdown"
title_ko: "Clarity Act — 튠 원내대표, 클로처 제출로 9월 15일 상원 표결 확정"
date: 2026-08-08
categories: crypto
tags: [crypto, bitcoin, regulation, CLARITY, legislation, senate]
excerpt: "Just a day after our post on the vague 'first thing when we come back' promise, Thune actually filed cloture on H.R. 3633 at 4:52 AM ET Saturday — turning that promise into a hard date: a cloture vote at 2:15 PM ET on Tuesday, September 15. Here's what filing cloture actually does (and doesn't) guarantee, and why the underlying vote math hasn't moved at all."
excerpt_en: "Just a day after our post on the vague 'first thing when we come back' promise, Thune actually filed cloture on H.R. 3633 at 4:52 AM ET Saturday — turning that promise into a hard date: a cloture vote at 2:15 PM ET on Tuesday, September 15. Here's what filing cloture actually does (and doesn't) guarantee, and why the underlying vote math hasn't moved at all."
excerpt_ko: "'복귀 후 가장 먼저'라는 모호한 약속을 다룬 글을 올린 지 하루 만에, 튠 원내대표가 토요일 새벽 4시 52분(ET) 실제로 H.R. 3633에 클로처를 제출했다 — 그 약속이 구체적인 날짜로 바뀌었다: 9월 15일 화요일 오후 2시 15분(ET) 클로처 표결. 클로처 제출이 실제로 무엇을 보장하고 무엇을 보장하지 않는지, 그리고 표 계산이 왜 전혀 바뀌지 않았는지 정리한다."
---
