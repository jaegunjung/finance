...
date: 2026-07-06
categories: macro
tags: [DXY, dollar, macro, bitcoin, emerging-markets, currency-cycle]
excerpt: "The U.S. dollar follows long multi-year cycles. Mapping DXY against crypto and equity returns reveals one of macro investing's clearest patterns."
excerpt_en: "The U.S. dollar follows long multi-year cycles. Mapping DXY against crypto and equity returns reveals one of macro investing's clearest patterns."
excerpt_ko: "미국 달러는 수년에 걸친 장기 사이클을 따른다. DXY를 크립토 및 주식 수익률과 매핑하면 매크로 투자에서 가장 명확한 패턴 중 하나가 드러난다."
---
