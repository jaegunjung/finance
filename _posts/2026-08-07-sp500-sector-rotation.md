...
date: 2026-08-07
categories: sp500
tags: [sector-rotation, sp500, macro, economic-cycle, GICS-sectors]
excerpt: "Mapping S&P 500 sector returns against the four phases of the economic cycle. Which sectors lead, which lag, and why."
excerpt_en: "Mapping S&P 500 sector returns against the four phases of the economic cycle. Which sectors lead, which lag, and why."
excerpt_ko: "S&P 500 섹터 수익률을 경기 사이클 4개 국면과 매핑한다. 어떤 섹터가 앞서고 뒤처지는지, 그 이유는."
---
...
**Phase 1 — Contraction (recession):**
GDP declining, unemployment rising, earnings falling, Fed easing

**Phase 2 — Early Recovery:**
GDP turning positive, employment stabilizing, credit conditions easing, earnings trough passed

**Phase 3 — Mid-Cycle Expansion:**
GDP growing above trend, employment rising, earnings growing, rates rising modestly

**Phase 4 — Late Cycle:**
GDP decelerating, labor market tight but softening, earnings growth slowing, rates near peak
...
세 가지 중요한 경고:
1. 국면은 겹치고 혼재한다
2. 각 국면의 기간은 크게 다르다 (2009~2020년 확장은 11년)
3. 기술처럼 세속적 테마가 사이클 패턴을 무효화한다
